    ...
    return (
        <div className="mt-24">
            <div className="flex flex-wrap lg:flex-nowrap justify-center ">
                ...
                <div
                    style={{width: "35.5rem"}}
                    className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 w-full p-8 pt-9 m-3 bg-[url('/src/data/bg-img.jpg')] bg-no-repeat bg-cover bg-center">
                    <div className="flex justify-between items-center">
                        <div>
                            <p className="font-bold text-gray-100">Earnings</p>
                            <p className="text-2xl text-gray-50">$63,448.78</p>
                        </div>
                        <button
                            type="button"
            ...
            <div className="flex gap-10 flex-wrap justify-center">
                <div>
                    <div
                        className=" md:w-400 p-4 m-3 mr-0"
                        style={{backgroundColor: currentColor}}
                    >
                        <div className="flex justify-between items-center ">
                    ...
                    <div
                        className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  md:w-400 p-8 m-3 flex justify-center items-center gap-10">
                        <div>
                ...
                <div style={{marginLeft: -7}}
                    className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 ml-0 p-4 md:w-800  ">
            ...
            <div className="flex gap-10 m-4 flex-wrap justify-center">
                ...
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 w-96 md:w-760">
            ...
            <div className="flex flex-wrap justify-center">
                <div className="md:w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  p-6 m-3">
                    <div className="flex justify-between">
                ...
                <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  p-6 m-3">
                    <div className="flex justify-between">
